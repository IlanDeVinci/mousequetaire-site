      ...
      <div className="relative h-[50vh] md:h-[70vh]">
        ...
        <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
          <div className="max-w-6xl mx-auto">
            <Link
              href="/portfolio"
              className="inline-block mb-6 text-blue-300 hover:text-blue-100 transition-colors"
            >
              ← Back to Portfolio
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="bg-gray-900 rounded-lg p-6 sticky top-8">
              ...
              <div className="mb-6">
                <h4 className="text-sm uppercase text-gray-400">Client</h4>
                <p className="text-lg">{project.client}</p>
              </div>

              <div className="mb-6">
                <h4 className="text-sm uppercase text-gray-400">Year</h4>
              ...
              <Link
                href="/contact"
                className="block w-full text-center bg-blue-600 hover:bg-blue-700 px-4 py-3 rounded-lg transition-colors mt-8"
              >
